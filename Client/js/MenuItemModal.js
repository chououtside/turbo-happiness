          ...
          <div className="modal-dialog">
              <div className="modal-content">
                  ...
                  <div className="modal-body">
                      ...
                      <form role="form">
                        ...
                        <div className="form-group specialInstructions">
                          ...
                          <textarea className="form-control" rows="5" id="specialInstructions"></textarea>
                        </div>
                  ...
                  <div className="modal-footer">
                      ...
                      <button type="button" className="btn btn-primary" data-dismiss='modal' onClick={() => this.props.addToCart(this.props.item, this.refs[`${this.props.id}-quantity`].value)}>
                          Save changes
                      </button>
                  </div>
              </div>
