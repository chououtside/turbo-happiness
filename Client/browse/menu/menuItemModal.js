    ...
    <div className='modal-dialog'>
      <div className='modal-content'>
        ...
        <div className='modal-body'>
          <h4>{`${name} - `}<IntlProvider locale='en'><FormattedNumber value={price} style='currency' currency='USD' /></IntlProvider></h4>
          <form role='form'>
            <div className='form-group'>
              <label htmlFor='quantitySelect'>Quantity</label>
              <select className='form-control' id='quantitySelect' ref={`${id}-quantity`}>
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>
